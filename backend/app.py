...
# Import routers
from routers import health, chat, tts, feedback, auth, documents, autonomous
...
async def read_index():
    ...
    # Try deployment path first (build/), then nested path (build/web/), then development path
    if os.path.exists("build/index.html"):
...
# Check deployment path first (build/), then nested path (build/web/), then development path
if os.path.exists("build/index.html"):
